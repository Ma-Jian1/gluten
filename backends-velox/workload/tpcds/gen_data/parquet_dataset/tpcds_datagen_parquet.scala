...
val rootDir = s"/workspaces/gluten/storage/tpcds-data/sf$scaleFactor" // root directory of location to create data in.
val dsdgenDir = "/workspaces/gluten/storage/tpcds-kit/tools" // location of dbgen
