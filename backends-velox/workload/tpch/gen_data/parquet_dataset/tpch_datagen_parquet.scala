...
val rootDir = s"/workspaces/gluten/storage/tpch-data/sf$scaleFactor" // root directory of location to create data in.
val dbgenDir = "/workspaces/gluten/storage/tpch-dbgen" // location of dbgen
